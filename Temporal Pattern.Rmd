...
<div style="text-align: center;">
  <img src="images/cute_cat2.jpg" width="60%" />
...
<br>
```{r, echo=FALSE, results='asis'}
cat('<div style="display: inline-block; width: 45%; text-align: center; vertical-align: top; margin: 10px;">')
include_graphics("images/hurt_owl.jpg")
cat('<div style="font-size: 12px; color: #666; font-style: italic; margin-top: 5px;">Image Credits: bestfriends</div>')
cat('</div>')

cat('<div style="display: inline-block; width: 44%; text-align: center; vertical-align: top; margin: 10px;">')
include_graphics("images/recovered_owl.png")
cat('<div style="font-size: 12px; color: #666; font-style: italic; margin-top: 5px;">Image Credits: bestfriends</div>')
cat('</div>')
```
...
cat('
<div style="text-align: center;">
  <img src="images/rooster.jpg" width="60%" />
  <p style="font-size:12px; color:gray; margin-top:4px;">
    Image Credits: bestfriends
  </p>
</div>
')
```
...
cat('
<div style="text-align: center;">
  <img src="images/falcon.jpg" width="60%" />
  <p style="font-size:12px; color:gray; margin-top:4px;">
    Image Credits: bestfriends
  </p>
</div>
