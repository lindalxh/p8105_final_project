...
The combined violin–boxplot shows clear differences in action duration across ranger actions.
...
The violin–boxplot shows how action duration differs across animal conditions.
...
duration_hours ~ final_ranger_action * animal_condition + num_animals
shows clear differences in action duration.
