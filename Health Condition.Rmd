...
This page analyzes animal health conditions across different species groups and New York City boroughs. Through descriptive statistics, visualizations, and statistical tests, it highlights patterns in reports of healthy, injured, and deceased animals. These insights help us better understand wildlife incidents in the city and support decisions related to ecological management and rescue resource allocation.

<br><br>


```{r, include=FALSE}
# Create color palette for bar plots
color_palette_0 = c(
  "#0868ac",
  "#43a2ca",
  "#7bccc4",
