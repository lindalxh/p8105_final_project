...
Overall, this analysis reveals that wildlife rescue operations in urban parks are shaped by a consistent interplay of spatial, temporal, and biological factors. Reporting frequency varies distinctly by borough and dominant animal class; case volume peaks during daylight hours and seasonal windows of high animal activity; reported health conditions reflect both species visibility and public detection patterns; response times are largely driven by initial report time and call source, instead of animal characteristics; and final ranger action varies significantly by animal conditions. 

The findings align with ecological expectations, though they also reveal some unexpected outcomes. Spatially, case distributions reflect borough characteristics, such as higher aquatic incidents in coastal Staten Island. Temporally, cases peak in summer and during daytime hours, matching wildlife and public activity patterns. Health reports correspond to species visibility - birds are more often reported with visible injuries, while concealed small mammals are found in poorer condition. However, we identified some unexpected patterns: response times depend more on call source and time of day than on animal traits, and the interaction between final action and animal condition significantly affects action duration.
...
To summarize, these patterns provide a data-informed foundation for understanding the dynamics of human-wildlife interactions in New York City and highlight several determinants of incident occurrence and system performance.
